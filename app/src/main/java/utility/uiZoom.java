...
public class uiZoom extends View {
    ...
    public uiZoom(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        defaultScale = uiZoom.DEFAULT_SCALE_FIT_INSIDE;
    }
    ...
    protected void onSizeChanged(int width, int height, int oldWidth, int oldHeight) {
        ...
        if (imgBitmap != null) {
            ...
            if (defaultScale == uiZoom.DEFAULT_SCALE_FIT_INSIDE) {
